  ...
  return (
    <>
      <div className="m-10 items-center justify-center md:m-20 lg-60 md:text-center">
          <h1 className="font-Fredericka text-3xl text-yellow-600 underline my-20">
            Hello, I am Mauro
          </h1>
          <div className="my-8 font-SpecialElite text-lg">
            FULL-STACK SOFTWARE ENGINEER | NODE.JS | JAVASCRIPT | REACT | MONGO DB
          </div>
          <div className="md:flex items-center">
            <span className="text-lg md:px-8 lg:px-16 md:mt-20 md:max-w-2xl font-SpecialElite">
